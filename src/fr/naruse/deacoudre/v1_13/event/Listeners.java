package fr.naruse.deacoudre.v1_13.event;
...
public class Listeners implements Listener {
    ...
    public Listeners(DacPluginV1_13 dacPlugin) {
        this.pl = dacPlugin;
    }
    ...
    public void inventoryClick(InventoryClickEvent e){
        ...
        if(pl.blockChoice.contains(e.getInventory())){
            e.setCancelled(true);
            if(e.getCurrentItem() != null){
                Player p = (Player) e.getWhoClicked();
                int currentInv = pl.blockChoice.getInventoryPlace(e.getInventory());
                if(e.getSlot() == 0){
                    p.closeInventory();
                    return;
                }
